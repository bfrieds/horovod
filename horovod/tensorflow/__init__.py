...
class LocalGradientAggregationHelper:
    def __init__(self, aggregation_frequency, allreduce_func=None):
        if allreduce_func == None:
            allreduce_func = lambda x: x
...
if _LegacyOptimizer is not None:
    class _DistributedOptimizer(_LegacyOptimizer):
        ...
        def __init__(self, optimizer, name=None, use_locking=False, device_dense='',
            ...
            self._agg_helper = LocalGradientAggregationHelper(aggregation_frequency, allreduce_func=self._allreduce_grads)
